...
public class PercentageOfClassAssertionEntailments extends DoubleValuedMetric {

	public PercentageOfClassAssertionEntailments(
	...
	public String getName() {
		return "Percentage of class assertion entailments";
	}
	...
	protected void setNumerator(ClassAssertionEtnailmentCount classAssertionEnt){
		super.setNumerator(classAssertionEnt.recomputeMetric());
	}
