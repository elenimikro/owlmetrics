...
public class PercentageOfSubClassEntailments extends DoubleValuedMetric {

	public PercentageOfSubClassEntailments(
	...
	public String getName() {
		return "Percentage of SubClass entailments";
	}
	...
	protected void setNumerator(OWLSubClassEntailmentCount subClassEnt){
		super.setNumerator(subClassEnt.recomputeMetric());
	}
