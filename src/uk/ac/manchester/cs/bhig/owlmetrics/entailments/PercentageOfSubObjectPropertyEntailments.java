...
public class PercentageOfSubObjectPropertyEntailments extends DoubleValuedMetric {

	public PercentageOfSubObjectPropertyEntailments(
	...
	public String getName() {
		return "Percentage of SubObject property entailments";
	}
	...
	protected void setNumerator(OWLSubObjectPropertyEntailmentCount subPropEnt){
		super.setNumerator(subPropEnt.recomputeMetric());
	}
